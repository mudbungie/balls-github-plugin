...
//! `balls-plugin-github-issues` (issue tracker) use: error types,
//! auth-dir-parameterized token I/O, the base GitHub HTTP client, and the
//! shared half of plugin config (`repo`, `api_base`).
//!
